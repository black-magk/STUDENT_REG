...
def test_valid_advance_method():
    testing_value = Student("Alice").advance('13th')
    
    assert testing_value == "Alice has advanced to the 13th grade"

# Write tests for Class methods
def test_valid_study_method():
    testing_value = Student("Alice").study('Computer Science')
    
    assert testing_value == "Alice is studying Computer Science"

# Write tests for Class methods
def test_valid_str_dunder_method():
    testing_value = str(Student("Francisco",15))
    
    assert testing_value == "Student 1: Name: Francisco, Age: 15, Grade: 12th"
